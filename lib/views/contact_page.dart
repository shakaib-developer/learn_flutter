                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                rowWith('images/phone.png',
                                    vm.contact.value.contactNo ?? ""),
                                rowWith('images/message.png',
                                    vm.contact.value.email ?? ""),
                                rowWith('images/location.png',
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      GestureDetector(
                                        ...
                                        onTap: () async {
                                          await vm.launchURL(
                                              vm.contact.value.instagramLink ??
                                                  "");
                                        },
                                      )
                                    ],
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text(
                                    'FRANK LIOYD WRIGHT',
                                    style:
                                        TextStyle(color: Styles.pageTextColor),
                                  )
                                ],
                              )),
                          SizedBox(height: 15),
