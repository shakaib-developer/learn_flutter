...
class BookServiceViewModel extends GetxController {
  ...
  Future<void> sendMail() async {
    ...
    String body = "Hello,\n\nYou have a new Booking request. Details are as "
        "follows:\n\nUsername:\t${booking.value.firstName} ${booking.value.lastName}\nEmail:\t${booking.value.email}\nPhone:\t${booking.value.phone}\nService Name:\t ${Get.find<ServicesListPageViewModel>().selectedService.value.serviceName}\nMessage:\n${booking.value.message}\n\n\nRegards,\nArchline App";
    ...
    try {
      ...
      Get.back();
      Get.snackbar("Success", "Your booking has been made successfully.",
          snackPosition: SnackPosition.BOTTOM,
          backgroundColor: Styles.appBarTextColor);
    } catch (error) {
      Get.snackbar("Oh No!", "Something went wrong.",
          snackPosition: SnackPosition.BOTTOM,
          backgroundColor: Styles.appBarTextColor);
    }
  }
